...
const Home = () => {
  return (
    <div id="home" className="overflow-hidden font-primary">
      ...
      <a
        href="#"
        className="scrollUp w-10 h-10 bg-blue flex justify-center items-center rounded z-10"
        id="scroll-up"
      >
        <svg
          width="16"
          ...
          className="group-hover:scale-125 fill-dark group-hover:fill-light transition duration-300 rotate-90"
        >
          <path
