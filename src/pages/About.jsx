...
const About = () => {
  return (
    <div className="min-h-screen bg-light dark:bg-dark">
        ...
        <div className="wrapper w-full h-full flex flex-col gap-y-8 md:flex-row">
          ...
          <div className="flex-1 h-full w-full flex items-center justify-center md:justify-end">
            <img
              src={AboutImg}
              alt="about hero"
              className="object-cover h-full md:h-[40vh] lg:h-[30vh] xl:h-[40vh] max-w-full"
            />
          </div>
        </div>
      </div>
      ...
      {/*  about content */}
      <div className="wrapper section flex flex-col gap-y-16 md:flex-row md:gap-x-10 xl:gap-x-16 text-dark dark:text-light">
        {/* text */}
        <div className="md:flex-[65%] flex flex-col gap-y-6 lg:gap-y-10 xl:gap-y-12">
          ...
          <div className="flex flex-col gap-y-4 lg:gap-y-6 font-light text-base lg:text-lg xl:text-xl">
            <p>
              ...
              been studying modern web development and UI/UX design for the last
              year. During this time I have created more than{" "}
            ...
            <p>
              ...
              Less and Bootstrap. I have some experience in backend development,
              I'm working on it :)
            </p>
            <p>
        ...
        <div className="md:flex-[35%] flex flex-col gap-y-4">
          ...
          <p className="font-light text-sm lg:text-base">
            My social networks and messengers are always open. Please feel free
