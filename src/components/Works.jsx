    ...
    <section id="works" className="bg-blue section">
      ...
      <div className="wrapper md:flex items-start justify-between mb-6">
        ...
        <div className="hidden md:flex gap-x-4">
          <div className="left w-10 h-10 border border-dark rounded-full flex items-center justify-center cursor-pointer hover:bg-light hover:border-light group">
            <svg
              width="16"
              height="16"
              viewBox="0 0 33 56"
          ...
          <div className="right rotate-180 w-10 h-10 border border-dark rounded-full flex items-center justify-center cursor-pointer hover:bg-light hover:border-light group">
            <svg
              width="16"
              height="16"
              viewBox="0 0 33 56"
